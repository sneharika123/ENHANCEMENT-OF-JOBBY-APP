...
class AllJobs extends Component {
  state = {
    ...
    apiJobsStatus: apiJobsStatusContants.initial,
  }
  ...
  onGetJobDetails = async () => {
    ...
    if (responseJobs.ok === true) {
      ...
      this.setState({apiJobsStatus: apiJobsStatusContants.failure})
    }
  }
  ...
  onRenderJobsStatus = () => {
    ...
    switch (apiJobsStatus) {
      case apiJobsStatusContants.success:
        return this.onGetJobsView()
      case apiJobsStatusContants.failure:
        return this.onGetJobsFailureView()
      case apiJobsStatusContants.inProgress:
        return this.renderLoadingView()
      default:
        return null
    }
